        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={form.hintQuestion} onChange={(e) => updateField('hintQuestion', e.target.value)} required
                className="w-full px-3 py-2 border border-[var(--border)] rounded-md bg-[var(--background)] text-[var(--foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
            ...
            <div>
              ...
              <input type="text" value={form.hintAnswer} onChange={(e) => updateField('hintAnswer', e.target.value)} required
                className="w-full px-3 py-2 border border-[var(--border)] rounded-md bg-[var(--background)] text-[var(--foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
